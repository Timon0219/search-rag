...
app = Celery('swirl_server', 
             broker='redis-11063.c273.us-east-1-2.ec2.redns.redis-cloud.com:11063', 
             backend='redis-11063.c273.us-east-1-2.ec2.redns.redis-cloud.com:11063')
```
...
CELERY_BROKER_URL = 'redis-11063.c273.us-east-1-2.ec2.redns.redis-cloud.com:11063'
# CELERY_BROKER_URL = 'amqp://guest:guest@localhost:6379//'

CELERY_RESULT_BACKEND = 'redis-11063.c273.us-east-1-2.ec2.redns.redis-cloud.com:11063'
